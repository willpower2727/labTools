function out = calcParameters_Dulce1(trialData,subData)
in=trialData;
...
paramlabels = {'good',...       Flag indicating whether the stride has events in the expected order or not
    ...
    'alphaSlow',...             ankle placement of slow leg at SHS2 (realtive to hip marker) (in mm)
    'alphaTemp',...             ankle placement of slow leg at SHS (in mm)
    ...
    'XSlow',...                 ankle postion of the slow leg at FHS (in mm)
    'XFast',...                 ankle position of Fast leg at SHS (in mm)
...
for step=1:Nstrides
    ...
    if good(t)
        ...
        if calcSpatial        
            ...
            %position of the conterlateral leg at HS
